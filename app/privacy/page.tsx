...
const company = siteConfig.company?.name ?? siteConfig.company?.fullName ?? "this business";
const email = siteConfig.contact?.email ?? siteConfig.footer?.contactEmail ?? "privacy@example.com";
const jurisdiction = siteConfig.contact?.location ?? siteConfig.footer?.address ?? "our operating region";
...
export default function PrivacyPolicyPage() {
  return (
    <section className="mx-auto max-w-3xl px-5 pb-24 pt-36 text-white md:px-8 md:pt-44">
        <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-primary/80">Legal</p>
